...
public class GradebookControllerTest {
    ...
    public void studentInformationHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 1))
                ...
                .andExpect(jsonPath("$.firstname", "Taha"))
                .andExpect(jsonPath("$.lastname", "Shah"))
                .andExpect(jsonPath("$.emailAddress", "tahashah@tahashah.com"));
    }
    ...
    public void createAValidGradeHttpRequest() throws Exception {
        this.mockMvc.perform(post("/grades")
                ...
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(jsonPath("$.id", is(1)))
                .andExpect(jsonPath("$.firstname",is( "Taha")))
                .andExpect(jsonPath("$.lastname", is("Shah")))
                .andExpect(jsonPath("$.emailAddress", is("tahashah@tahashah.com")))
    ...
    @Test
    public void createAValidGradeHttpRequestSubjectDoesNotExistEmptyResponse() throws Exception {
        this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
    ...
    @Test
    public void deleteAValidGradeHttpRequestGradeIdDoesNotExistEmptyResponse() throws Exception {

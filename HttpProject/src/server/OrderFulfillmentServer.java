            ...
            server.createContext("/", exchange -> {
                ...
                if (parameters.size() == 2) {
                    ...
                    response = """
                            ...
                            """.formatted(getNextID(), parameters.get("product"), parameters.get("amount"), now.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME), delivery.format(DateTimeFormatter.ISO_LOCAL_DATE))
                            .replaceAll("\\s", "");

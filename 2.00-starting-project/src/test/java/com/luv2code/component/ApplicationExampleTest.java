...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setEmailAddress("ericroby@luv2code_school.com");
        studentGrades.setMathGradeResults(new ArrayList<>(Arrays.asList(100.0, 85.0, 76.50, 91.74)));
    ...
    public void addGradeResultsForStudentGrades() {
        assertEquals(353.24, studentGrades.addGradeResultsForSingleClass(student.getStudentGrades().getMathGradeResults()));
    }

    @DisplayName("Add grade reults for student grades not equal")
    @Test

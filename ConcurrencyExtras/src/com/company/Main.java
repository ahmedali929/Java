//the importance of using atomic classes so that multiple threads dont access a method or class at once. otherwise the method/class might skip the operation(s) at that time

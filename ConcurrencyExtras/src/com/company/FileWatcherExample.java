//an examples of a WatcherService
//when you run this program, the console returns any changes done to the working directory, i.e. if a file is added, modified, or deleted

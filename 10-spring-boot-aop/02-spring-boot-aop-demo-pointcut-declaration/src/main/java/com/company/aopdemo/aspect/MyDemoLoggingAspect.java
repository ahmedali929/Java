...
public class MyDemoLoggingAspect {
    ...
    public Object aroundGetFortune(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            result = "Major accident! But no worries, take this detour on Main Street.";
        }
    ...
    @AfterThrowing(pointcut="execution(* com.company.aopdemo.dao.AccountDAO.findAccounts(..))", throwing="theExc")
    ...
    @AfterReturning(pointcut="execution(* com.company.aopdemo.dao.AccountDAO.findAccounts(..))", returning="result")

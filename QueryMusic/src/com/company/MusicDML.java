...
public class MusicDML {
    ...
    public static void main(String[] args) {
        try (
                Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/music", System.getenv("MYSQL_USER"), System.getenv("MYSQL_PASS"));
    ...
    private static void deleteArtistAlbum(Connection conn, Statement statement, String artistName, String albumName) throws SQLException{
        try {
            ...
            String deleteSongs = "DELETE FROM music.songs WHERE album_id = (SELECT album_id FROM music.albums WHERE album_name = '%s')".formatted(albumName);
